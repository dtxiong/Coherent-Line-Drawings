...
int main()
{
    ...
    // lineConstruction(flower, 5.0f, 3.0f, 0.99f, 1.0f, 5.0f, 3, 1.0f).write("Output/flowerLine.png");
    ...
    lineConstruction(baboon, 3.0f, 1.0f, 0.99f, 1.0f, 3.0f, 3, 1.0f).write("Output/baboonLine.png");
    */
    /*
    ...
    */
    Image montauk = Image("Input/montauk/00040.png");
    //lineConstruction(montauk, 3.0f, 2.0f, 0.99f, 1.0f, 3.0f, 1, 1.0f).write("Output/montauk.png");
    //video sequence
